...
| ideas | A candidate worth doing that nobody has committed to yet - not a task, which is already committed and just waiting. | Cognitive commits in this project's event log. | [ideas.md](ideas.md), then `maps show ideas --around 'idea:<name>'`. |
