...
| Presentation | `server` | `percept review` - serves the embedded review page and, later, the JSON the page reads and writes, over the same log and maps the CLI uses. |
