...
/// Tokens of context a known OpenAI model holds, matched by name prefix
/// since a family (Sol, Terra, Luna, ...) shares one window. `None` for
/// a name this table doesn't recognize - not a guess.
