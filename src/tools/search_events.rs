...
const PARAMETERS: &str = r#"{
  ...
  "properties": {
    ...
    "kinds": {"type": "array", "items": {"type": "string", "enum": ["message.received", "thought.recorded", "tool.called", "tool.resulted", "node.added", "edge.added", "model.called", "session.started", "file.cited"]}},
