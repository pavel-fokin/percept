...
const PARAMETERS: &str = r#"{
  ...
  "properties": {
    ...
    "kinds": {"type": "array", "items": {"type": "string", "enum": ["message.received", "thought.recorded", "tool.called", "tool.resulted", "map.created", "node.added", "node.removed", "edge.added", "edge.removed", "model.called", "session.started", "reflection.started", "file.cited"]}},
